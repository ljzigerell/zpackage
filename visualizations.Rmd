...
```{r base1, exercise=TRUE, exercise.lines=4}
...
```{r base2, exercise=TRUE, exercise.lines=4}
...
```{r tibble_GUNIMP, exercise=TRUE, exercise.lines=14, message=FALSE, warning=FALSE}
...
```{r GUNIMP_ggplot_1A, exercise=TRUE, exercise.lines=14}
...
```{r GUNIMP_ggplot_2A, exercise=TRUE, exercise.lines=15}
...
```{r GUNIMP_ggplot_2B, exercise=TRUE, exercise.lines=16}
...
```{r GUNIMP_ggplot_2C, exercise=TRUE, exercise.lines=16}
...
```{r GUNIMP_ggplot_2D, exercise=TRUE, exercise.lines=17}
...
```{r GUNIMP_ggplot_2E, exercise=TRUE, exercise.lines=17}
...
```{r STATES1, exercise=TRUE, exercise.lines=40}
...
```{r ggsave, exercise=TRUE, exercise.lines=23, message=FALSE, warning=FALSE}
...
```{r GUNIMP_ggplot_3A, exercise=TRUE, exercise.lines=19}
...
```{r GUNIMP_ggplot_4A, exercise=TRUE, exercise.lines=20}
...
```{r GUNIMP_ggplot_4B, exercise=TRUE, exercise.lines=20}
...
```{r GUNIMP_ggplot_4C, exercise=TRUE, exercise.lines=20}
...
```{r GUNIMP_ggplot_4D, exercise=TRUE, exercise.lines=20}
...
```{r GUNIMP_ggplot_4E, exercise=TRUE, exercise.lines=21}
...
```{r GUNIMP_ggplot_4F, exercise=TRUE, exercise.lines=20}
...
```{r GUNIMP_ggplot_5A, exercise=TRUE, exercise.lines=21}
...
```{r GUNIMP_ggplot_5B, exercise=TRUE, exercise.lines=21}
...
```{r GUNIMP_ggplot_5C, exercise=TRUE, exercise.lines=27}
...
```{r GUNIMP_ggplot_6A, exercise=TRUE, exercise.lines=28}
...
```{r GUNIMP_ggplot_6B, exercise=TRUE, exercise.lines=28}
...
```{r GUNIMP_ggplot_7A, exercise=TRUE, exercise.lines=38}
...
```{r GUNIMP_ggplot_7B, exercise=TRUE, exercise.lines=45}
...
```{r NRA1, exercise=TRUE, exercise.lines=30}
...
```{r NRA2, exercise=TRUE, exercise.lines=30}
...
```{r NRA3, exercise=TRUE, exercise.lines=30}
...
```{r NRA4, exercise=TRUE, exercise.lines=32}
...
```{r TRUMP1, exercise=TRUE, exercise.lines=24}
...
```{r TRUMP2, exercise=TRUE, exercise.lines=25}
...
```{r JITTER1, exercise=TRUE, exercise.lines=27}
...
```{r JITTER2, exercise=TRUE, exercise.lines=27}
...
```{r JITTER3, exercise=TRUE, exercise.lines=27}
...
```{r PATCHWORK, exercise=TRUE, exercise.lines=53}
...
```{r LEGEND1, exercise=TRUE, exercise.lines=35}
...
```{r LEGEND2, exercise=TRUE, exercise.lines=37}
...
3. Edit the code below so that the x-axis order from left-to-right is "Male" "Female". Do not change the DATA line.

```{r trouble3, exercise=TRUE, exercise.lines=10}

DATA <- tribble(~X, ~Y, "Male", 40, "Female", 60)
...
```{r practice2, exercise=TRUE, exercise.lines=23}
...
```{r practice3, exercise=TRUE, exercise.lines=50}
