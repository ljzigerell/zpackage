...
First, R packages must be put on your computer using a command such as **install.packages("tidyverse")** or **install.packages("tidyverse", dependencies=TRUE, repos="http://cran.us.r-project.org")**, which will download the **tidyverse** package to your computer.

```{r tidyverse_install, eval=TRUE, exercise=FALSE, message=TRUE, warning=TRUE}
...
```{r emphasis1, echo=FALSE, exercise=TRUE, eval=TRUE, results=FALSE, fig.width=8, fig.height=4}
...
```{r emphasis2, echo=FALSE, exercise=TRUE, eval=TRUE, results=FALSE, fig.width=8, fig.height=5}
...
>>>>>>> 3cd3be0a1b5a8cb3434005a791dae1948b80b8af
```
